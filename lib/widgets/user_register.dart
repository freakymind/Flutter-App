            ...
            children: <Widget>[
              ...
              new RaisedButton(
                onPressed: () async {
                  ...
                  // UserRegister user = await RestApis().createUser(userReg);
                  print('Company request details : ' + userReg.company_name);
                  Navigator.push(
                      context,
                      MaterialPageRoute(
...
class UserDataWidget extends StatefulWidget {
  @override
  UserDataWidgetState createState() {
    return UserDataWidgetState();
  }
}
          ...
          child: Column(
            children: <Widget>[
              ...
              new TextField(
                ...
                decoration: InputDecoration(
                    hintText: "User Mobile", labelText: "User Mobile"),
              ),
              new TextField(
                controller: useraddress,
                decoration: InputDecoration(
                    hintText: "User Address", labelText: "User Address"),
              ),
              new TextField(
                controller: usercountry,
                decoration: InputDecoration(
                    hintText: "User Country", labelText: "User Country"),
              ),
              new TextField(
